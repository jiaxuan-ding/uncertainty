# -*- coding: utf-8 -*-
"""
Created on Wed Oct 30 10:07:18 2024
...
def cal_LL(param, C, data_att, w_p,Nid, Nscenario,Nalter,Nattri,L):
    ...
    epsilon=1
    S=np.eye(Nalter)-phi2*np.exp(-phi1*Distsq)#feedback matrix: S 
...
######################estimation##########################
Nfeval = 1
bounds=((-np.Inf,np.Inf),(-np.Inf,np.Inf),(0.1,10),(0.1,10),(0.1,10),(-6,np.Inf),(-8.5,10))
...
print  ('{0}      {1}       {2}        {3}        {4}        {5}        {6}        {7}       {8}'.format('Iter', ' phi1', ' phi2',  ' w1', ' w2', ' w3', 't_step','ASC_EV','-llh'))     

initial=np.array([0.023669142	,0.395623586,	1.747183977	,1.454334799	,2.133084675,	-2.844174301,	0.29085658])
...
###########################################return results########################################
info = f"""
Estimation summary for DFT with eye-tracking
------------------------------------------------------------------------------------
